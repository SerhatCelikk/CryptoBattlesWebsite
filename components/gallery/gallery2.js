  ...
  return (
    ...
    <div className={styles.combine}>
        <div className={styles.area1} >
            <img className={styles.img1}src="https://streetmachine.oss-us-west-1.aliyuncs.com/images/gallery/img.png"/>
        </div>

        <div className={styles.area2} >
            <div className={styles.gallery2}>
                <img className={styles.img2} src="https://streetmachine.oss-us-west-1.aliyuncs.com/images/gallery/02.jpg" />
                <img className={styles.img22} src="https://streetmachine.oss-us-west-1.aliyuncs.com/images/gallery/03.jpg"/>
            </div>
